...
eval_cfg = EvalCfg(
    agent=AgentCfg(
        ...
        model_settings={
            ...
            'vis_debug_path': './logs/20251208_rdp_physical_vlnverseRealFine_ckptC2_82001_val_unseen_vis/vis_debug',
        },
    ),
    env=EnvCfg(
        env_type='vln_pe',
    ...
    task=TaskCfg(
        task_name='20251208_rdp_physical_vlnverseRealFine_ckptC2_82001_val_unseen_vis',
        task_settings={
            'env_num': 1,
