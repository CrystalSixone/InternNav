from internnav.configs.model.seq2seq_vlnverse import seq2seq_cfg
...
seq2seq_plus_vlnverse_exp_cfg = ExpCfg(
    ...
    il=IlCfg(
        ...
        ckpt_to_load='checkpoints/r2r/fine_tuned/seq2seq_plus',
        lmdb_map_size=1e12,
        dataset_r2r_root_dir='data/vln_pe/raw_data/vlnverse/final_splits_with_distance_formal/total',
        dataset_3dgs_root_dir='',
        dataset_grutopia10_root_dir='',
        lmdb_features_dir='vlnverse',
        lerobot_features_dir='data/vln_pe/traj_data/vlnverser',
